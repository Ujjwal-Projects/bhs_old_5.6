...
class pagingRecords
{
	...
	function pagewise($numrows,$pageno=1,$lnkParam="",$limit="",$lnkScr="")
	{
		...
		if($selectedPg!=1)
		{
			...
			{	
				if($this->htpaging){
					$pgStr.="<li><a class='".CSSFL."' href=\"".FURL.$this->htpaging."/page/1/".$lnkParam."\" title=\"FIRST\">".$this->firstText."</a></li>&nbsp;  ";
				} else {
					$pgStr.="<li><a class='".CSSFL."' href=\"".$this->linksrc."?pageno=1".$lnkParam."\" title=\"FIRST\">".$this->firstText."</a></li>&nbsp;  ";
				}
			}
			if($this->nextprev==1)
			{
				...
				if($this->htpaging){
					$pgStr.="<li><a class='".CSSNP."' href=\"".FURL.$this->htpaging."/page/".$newpageno."/".$lnkParam."\" title=\"PREV\">".$this->prevText."</a></li>&nbsp;  ";
				} else {
					$pgStr.="<li><a class='".CSSNP."' href=\"".$this->linksrc."?pageno=".$newpageno.$lnkParam."\" title=\"PREV\">".$this->prevText."</a></li>&nbsp;  ";
				}
			}
		}
		if(!$this->simplepaging && !$this->dropdownpaging)
		{
			for ($i=$st_page; $i<=$end_page; $i++)
			{
				if($selectedPg == $i)
				{
					$pgStr.="<li class='active'><a class='active'>".$i."</a></li> &nbsp; ";
				}
				else
				{	
					if($this->htpaging){
						$pgStr.="<li><a class='".CSSPN."' href=\"".FURL.$this->htpaging."/page/".$i."/".$lnkParam."\">".$i."</a></li>";
					} else {
						$pgStr.="<li><a class='".CSSPN."' href=\"".$this->linksrc."?pageno=".$i.$lnkParam."\">".$i."</a></li>";
					}
				}
			}
		}
		...
		if($selectedPg!=$pages)
		{
			if($this->nextprev==1)
			{
				$newpageno = abs($selectedPg+1);
				if($this->htpaging){
					$pgStr.="<li><a class='".CSSNP."' href=\"".FURL.$this->htpaging."/page/".$newpageno."/".$lnkParam."\" title=\"NEXT\">".$this->nextText."</a></li>";
				} else {
					$pgStr.="<li><a class='".CSSNP."' href=\"".$this->linksrc."?pageno=".$newpageno.$lnkParam."\" title=\"NEXT\">".$this->nextText."</a></li>";
				}
			}
			if(!$this->normalpaging && $this->firstlast==1)
			{
				if($this->htpaging){
					$pgStr.=" <li><a class='".CSSFL."' href=\"".FURL.$this->htpaging."/page/".$pages."/".$lnkParam."\" title=\"LAST\">".$this->lastText."</a></li>";
				} else {
					$pgStr.=" <li><a class='".CSSFL."' href=\"".$this->linksrc."?pageno=".$pages.$lnkParam."\" title=\"LAST\">".$this->lastText."</a></li>";
				}
			}
		}
		//$pgStr.="</td></tr>";
