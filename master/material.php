...
if($_POST['Save']=='add'){	
	...
	$_POST['id']='0';
	$_POST['notice_for']=$teacher['stream'];
	$_POST['post_date']=date('Y-m-d');
	$_POST['teacher_name']=$teacher['full_name'];
	...
	//pre($_POST);die;
	$obj->updateData(TABLE_MATERIAL,$_POST,"id='".$_POST['id']."'");	
	   ...
	   <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
					$i=1;
					$res = $obj->selectData(TABLE_MATERIAL,"","status<>'deleted' order by id desc");	
